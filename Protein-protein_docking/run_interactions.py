...
output_directory = r"C:\Users\..\..\P720Q"
...
def is_hydrophobic(atom_name):
    return atom_name.startswith(("C", "S"))

def is_hbond(atom1, atom2):
    return (atom1 in ("N", "O") and atom2 in ("O", "N"))

def is_salt_bridge(atom1, atom2):
    positive_atoms = {"NZ", "NH1", "NH2", "NE", "ND1", "ND2"}
    negative_atoms = {"OD1", "OD2", "OE1", "OE2"}
    return (atom1 in positive_atoms and atom2 in negative_atoms) or (atom1 in negative_atoms and atom2 in positive_atoms)

def is_vdw(dist):
    return 1.6 < dist <= 4.0

def is_aromatic(atom1, atom2):
    aromatic_atoms = {"CG", "CD1", "CD2", "CE1", "CE2", "CZ", "CH"}
    return atom1 in aromatic_atoms and atom2 in aromatic_atoms

def is_cation_pi(atom1, atom2):
    cation_atoms = {"NZ", "NH1", "NH2", "NE"}
    pi_atoms = {"CG", "CD1", "CD2", "CE1", "CE2", "CZ", "CH"}
    return (atom1 in cation_atoms and atom2 in pi_atoms) or (atom2 in cation_atoms and atom1 in pi_atoms)
